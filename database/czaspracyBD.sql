CREATE TABLE Employee (Employee_ID  SERIAL NOT NULL, First_Name varchar(30) NOT NULL, Last_Name varchar(50) NOT NULL, Email varchar(255) NOT NULL, Password varchar(50) NOT NULL, PRIMARY KEY (Employee_ID));
